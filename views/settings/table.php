<?php
use WpPluginHub\Plugin\Table;

$config = [
	'per_page'		=> 5,
	'columns'		=> [
		'id'				=> __( 'Order #', 'cloud-server-management' ),
		'products'			=> __( 'Products', 'cloud-server-management' ),
		'order_total'		=> __( 'Order Total', 'cloud-server-management' ),
		'commission'		=> __( 'Commission', 'cloud-server-management' ),
		'payment_status'	=> __( 'Payment Status', 'cloud-server-management' ),
		'time'				=> __( 'Time', 'cloud-server-management' ),
	],
	...
	'bulk_actions'	=> [
		'delete'	=> __( 'Delete', 'cloud-server-management' ),
		'draft'		=> __( 'Draft', 'cloud-server-management' ),
	],
];
