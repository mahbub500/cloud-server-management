...
final class Plugin {
	...
	private function define() {
		 ...
		 * @since 0.9
		 */
		define( 'CLOUD_SERVER_MANAGEMENT', __FILE__ );
		define( 'CLOUD_SERVER_MANAGEMENT_DIR', dirname( CLOUD_SERVER_MANAGEMENT ) );
		define( 'CLOUD_SERVER_MANAGEMENT_ASSET', plugins_url( 'assets', CLOUD_SERVER_MANAGEMENT ) );
		define( 'CLOUD_SERVER_MANAGEMENT_DEBUG', apply_filters( 'cloud-server-management_debug', true ) );
		 ...
		 * @var $plugin
		 */
		$this->plugin					= get_plugin_data( CLOUD_SERVER_MANAGEMENT );
		$this->plugin['basename']		= plugin_basename( CLOUD_SERVER_MANAGEMENT );
		$this->plugin['file']			= CLOUD_SERVER_MANAGEMENT;
		$this->plugin['server']			= apply_filters( 'cloud-server-management_server', 'https://codexpert.io/dashboard' );
